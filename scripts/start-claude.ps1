# Script spécifique au projet Quebec-IA-Labs
Write-Host "🚀 Démarrage Claude Code pour Quebec-IA-Labs" -ForegroundColor Cyan
...
# Lance Claude avec le contexte
claude-code --files claude.md,requirements.txt --prompt "Contexte: $projectContext. Que veux-tu faire?"