      ...
      <div class="container">
        ...
        <div style="margin-top: 30px; background: rgba(40, 167, 69, 0.2); padding: 20px; border-radius: 10px;">
          ...
          <ul style="text-align: left; max-width: 400px; margin: 0 auto;">
            <li>Voix masculine: Polly.Jean-Neural</li>
...
<Response>
    <Say voice="Polly.Jean-Neural" language="fr-CA">${greeting}</Say>
    <Gather input="speech" action="/webhook/twilio" method="POST" language="fr-CA" speechTimeout="3" timeout="6">
    </Gather>
    <Say voice="Polly.Jean-Neural" language="fr-CA">Désolé, je n'ai pas bien entendu. Rappellez-nous! Au revoir.</Say>
    <Hangup/>
</Response>`;
...
<Response>
    <Say voice="Polly.Jean-Neural" language="fr-CA">${response}</Say>
    <Pause length="1"/>
    <Say voice="Polly.Jean-Neural" language="fr-CA">${randomEnding} Au revoir!</Say>
    <Hangup/>
</Response>`;
...
<Response>
    ...
    <Say voice="Polly.Jean-Neural" language="fr-CA">Parfait! Merci de votre appel. Au revoir!</Say>
    <Hangup/>
</Response>`;
...
<Response>
    <Say voice="Polly.Jean-Neural" language="fr-CA">Désolé, problème technique. Rappellez dans quelques minutes.</Say>
    <Hangup/>
</Response>`;
...
app.get("/webhook/twilio/test", (req, res) => {
  res.json({
    ...
    fixes: [
      "Voix masculine (Polly.Jean-Neural)",
...
app.get("/health", (req, res) => {
  res.json({
    ...
    fixes: [
      "Voice: Polly.Jean-Neural (masculine)",
