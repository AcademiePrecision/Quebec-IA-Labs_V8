...
// Additional CEO profiles for full testing access
export const ceoSalonProfile: SalonPartenaireProfile = {
  id: 'profile-ceo-salon-001',
  accountId: 'account-ceo-001',
  userType: 'salon_partenaire',
  isActive: true,
  salonName: 'Académie Précision - Salon Test',
  salonAddress: '123 Test Avenue, Québec, QC G1R 2S3',
  businessNumber: 'CEO-TEST-123456789',
  website: 'www.academieprecision.com',
  employeeCount: 50,
  yearsExperience: 25,
  servicesOffered: ['Formation complète', 'Certification', 'Perfectionnement', 'Consultation business'],
  equipmentAvailable: ['Équipement de formation professionnel', 'Outils pédagogiques avancés'],
  workingHours: 'Lun-Ven: 8h-18h',
  createdAt: '2024-01-01T08:00:00.000Z',
  updatedAt: '2024-01-01T08:00:00.000Z'
};

export const ceoFormateurProfile: MaitreFormateurProfile = {
  id: 'profile-ceo-formateur-001',
  accountId: 'account-ceo-001',
  userType: 'maitre_formateur',
  isActive: true,
  specialties: ['Formation de formateurs', 'Développement curricula', 'Leadership pédagogique', 'Innovation éducative'],
  yearsExperience: 25,
  certifications: ['Maître Formateur Certifié', 'Expert en Pédagogie', 'Consultant Business', 'Leader Innovation'],
  portfolio: ['Portfolio CEO Formation', 'Curriculum Académie Précision'],
  hourlyRate: 200,
  weeklyAvailability: 'Lun-Ven: 9h-17h',
  professionalBio: 'Fondateur et CEO de l\'Académie Précision, expert en formation professionnelle avec 25 ans d\'expérience dans l\'innovation pédagogique',
  createdAt: '2024-01-01T08:00:00.000Z',
  updatedAt: '2024-01-01T08:00:00.000Z'
};

export const ceoEtudiantProfile: AcademicienBarbierProfile = {
  id: 'profile-ceo-etudiant-001',
  accountId: 'account-ceo-001',
  userType: 'academicien_barbier',
  isActive: true,
  experienceLevel: 'avance',
  specialtiesOfInterest: ['Innovation pédagogique', 'Nouvelles techniques', 'Tendances marché'],
  trainingGoals: 'Tester et valider l\'expérience étudiant complète',
  employerSalon: undefined,
  monthlyTrainingBudget: 1000,
  createdAt: '2024-01-01T08:00:00.000Z',
  updatedAt: '2024-01-01T08:00:00.000Z'
};
...
export const initializeCoreData = (): { accounts: BaseAccount[], profiles: UserProfile[] } => {
  ...
  const profiles = deduplicateById([ceoProfile, ceoSalonProfile, ceoFormateurProfile, ceoEtudiantProfile, ...debugTestProfiles]);
