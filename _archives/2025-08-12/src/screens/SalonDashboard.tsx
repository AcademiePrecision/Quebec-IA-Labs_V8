      ...
      <View style={{ paddingTop: insets.top, flex: 1 }}>
        ...
        >
          ...
          <View style={{ paddingHorizontal: 24, paddingVertical: 16 }}>
            <ReadableText style={[styles.title, { textAlign: 'left', marginBottom: 8 }]}>
            ...
            {onNavigateToAIValet && (
              <View style={{ marginTop: 16 }}>
                <AcademieButton
                  title="🤖 Nouveau: Valet IA - Manager Invisible"
                  onPress={onNavigateToAIValet}
                  variant="primary"
                  size="lg"
                />
                <ReadableText style={[styles.caption, { textAlign: 'center', marginTop: 8, fontStyle: 'italic' }]}>
                  {language === 'fr' 
